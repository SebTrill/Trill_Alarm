...
namespace Alarm_GUI
{
    public partial class Alarm501 : Form
    {
        ...
        public void SetConstructor(ReadFile_DEL rf, MakeAlarmText_DEL mat, Write2TXT_DEL wr, CheckAlarms_DEL ca, SelectedEventHelper_DEL select, 
            StopEventHelper_DEL stop, SnoozeEventHelper_DEL snooze, EditEventHelper_DEL edit, MakeNewAddEdit_DEL newEdit)
        {
            read = rf;
            text = mat;
            write = wr;
        ...
        /// <param name="sender">This is the Form.</param>
        /// <param name="e">These are the arguments.</param>
        private void Alarm501_Load(object sender, EventArgs e) { read(1); }

        /// <summary>
        /// This prints out a message for too many alarms.
        /// </summary>
        public void TooManyAlarmMessage() { MessageBox.Show("Can't make any more alarms!"); }
